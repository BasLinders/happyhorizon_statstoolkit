...
st.write("### <span style='color: orange;'>v1.6.4 (beta)</span>", unsafe_allow_html=True)
st.write("""
...
### Features
<span style='color:#009900; font-weight: 600; margin-right: 6px;'>&#10003;</span>**Bayesian analysis**: Calculate the probability of a winner and make a business case<br>
<span style='color:#009900; font-weight: 600; margin-right: 6px;'>&#10003;</span>**Frequentist analysis**: Calculate significance for your test variant as tangible proof for a winner<br>

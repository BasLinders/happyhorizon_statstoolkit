...
while True:
    try:
        visitors_a = float(input("How many visitors did A have? "))
        visitors_b = float(input("How many visitors did B have? "))
...
proportion_a = int(input("What percentage of users should be in A? "))
proportion_b = int(input("What percentage of users should be in B? "))

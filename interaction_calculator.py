...
with col1:
    AA_u = st.number_input("AA Visitors", value=12364)
    AB_u = st.number_input("AB Visitors", value=12219)
    BA_u = st.number_input("BA Visitors", value=12305)
    BB_u = st.number_input("BB Visitors", value=12496)
with col2:
    AA_c = st.number_input("AA Conversions", value=496)
    AB_c = st.number_input("AB Conversions", value=470)
    BA_c = st.number_input("BA Conversions", value=497)
    BB_c = st.number_input("BB Conversions", value=483)

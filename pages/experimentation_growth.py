...
def run():
    ...
    st.session_state.setdefault("n_experiments_max", 0)
    ...
    with col1:
        ...
        st.session_state.used_months = st.number_input("Over how many months is the data below been collected?", min_value=0, max_value=12, step=1, value=st.session_state.used_months)
    ...
    with col2:
        ...
        st.session_state.n_experiments_max = st.number_input("What is the maximum amount of experiments in the estimate?")
    ...
    # Check if used_months > 0
    if used_months == 0:
        st.error("The 'used_months' value cannot be zero. Please enter a value greater than 0.")
        st.stop()
